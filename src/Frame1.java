...
public class Frame1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Watermelon", 0, 14)); // NOI18N
        jLabel1.setText("Hasil Biodata");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(160, 20, 150, 50);

        Hasil5.setFont(new java.awt.Font("Palatino Linotype", 0, 12)); // NOI18N
        Hasil5.setText("Hasil5");
        getContentPane().add(Hasil5);
        Hasil5.setBounds(150, 240, 230, 20);

        Hasil1.setFont(new java.awt.Font("Palatino Linotype", 0, 12)); // NOI18N
        Hasil1.setText("Hasil1");
        getContentPane().add(Hasil1);
        Hasil1.setBounds(150, 80, 230, 20);

        Hasil2.setFont(new java.awt.Font("Palatino Linotype", 0, 12)); // NOI18N
        Hasil2.setText("Hasil2");
        getContentPane().add(Hasil2);
        Hasil2.setBounds(150, 120, 230, 20);

        Hasil3.setFont(new java.awt.Font("Palatino Linotype", 0, 12)); // NOI18N
        Hasil3.setText("Hasil3");
        getContentPane().add(Hasil3);
        Hasil3.setBounds(150, 160, 230, 20);

        Hasil4.setFont(new java.awt.Font("Palatino Linotype", 0, 12)); // NOI18N
        Hasil4.setText("Hasil4");
        getContentPane().add(Hasil4);
        Hasil4.setBounds(150, 200, 230, 20);
